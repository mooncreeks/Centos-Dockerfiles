#!/bin/bash
### Description: Start ssh-mysql service in container
...
__create_user() {
#  create ssh user used to ssh log-in
# pwgen 
...
# -1 : Don't print the generated passwords in cloumns, will get only one password
SSH_USERPASS=`pwgen -c -n -y -1 8`
